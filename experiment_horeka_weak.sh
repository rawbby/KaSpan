...
BUILD_DIR=. MACHINE=horeka python _deps/kaval-src/run-experiments.py --machine horeka --sbatch-template _deps/kaval-src/sbatch-templates/horeka.txt --command-template _deps/kaval-src/command-templates/horeka-IntelMPI.txt --search-dirs ../experiment/horeka/weak
