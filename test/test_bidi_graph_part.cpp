...
main()
{
  ...
  {
    constexpr auto part = single_part{};
    auto const     bgp  = bidi_graph_part{ part, 0, 0 };
  ...
  {
    constexpr vertex_t n = 2;

    constexpr auto part = single_part{ n };
    auto const     bgp  = bidi_graph_part{ part, 1, 1 };
