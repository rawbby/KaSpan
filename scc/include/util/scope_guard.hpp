...
#define SCOPE_GUARD_1(F0) [[maybe_unused]] auto const CAT(guard, __COUNTER__) = ScopeGuard([&] { \
                            F0;                                                                  \
                          })
#define SCOPE_GUARD_2(F0, F_) [[maybe_unused]] auto const CAT(guard, __COUNTER__) = ScopeGuard([&] { \
                                F0;                                                                  \
                              },                                                                     \
                                                                                               [&] { \
                                                                                                 F_; \
