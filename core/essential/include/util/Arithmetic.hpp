...
template<typename T> concept UnsignedConcept = not std::is_enum_v<T> and (
...
template<typename T> concept IntConcept  = UnsignedConcept<T> or SignedConcept<T>;
template<typename T> concept U128Concept = UnsignedConcept<T> and (sizeof(T) == 16);
template<typename T> concept U64Concept  = UnsignedConcept<T> and (sizeof(T) ==  8);
template<typename T> concept U32Concept  = UnsignedConcept<T> and (sizeof(T) ==  4);
template<typename T> concept U16Concept  = UnsignedConcept<T> and (sizeof(T) ==  2);
template<typename T> concept U8Concept   = UnsignedConcept<T> and (sizeof(T) ==  1);
